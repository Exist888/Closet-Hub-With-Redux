...
// FOR TS: declare module for *.png in src/types/custom.d.ts
import logo from "../../assets/logo.png";
import "./PaymentForm.scss";

// FOR TS: Type the setter function passed into this component
type PaymentFormProps = {
    // FOR TS: React and TS syntax for setter function prop in child component
    setOpenPaymentForm: Dispatch<SetStateAction<boolean>>
}

export function PaymentForm({ setOpenPaymentForm }: PaymentFormProps): JSX.Element {
    ...
    async function handleSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            // FOR TS: create early return to avoid passing undefined as value
            ...
            if (paymentResult.error) {
                // FOR TS: Check whether error message exists to avoid passing in undefined type
